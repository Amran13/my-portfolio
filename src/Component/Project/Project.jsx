...
const Project = () => {
    return (
        <div id='project' className='lg:h-screen text-white'>
            <h1 className='lg:text-4xl text-2xl font-extrabold text-rose-500 text-center pt-6 mb-6 lg:mb-12 '>Projects</h1>
            ...
            <div className='grid lg:grid-cols-3 grid-col-1 lg:gap-6 gap-4'>
                ...
                <div className="card lg:w-96 bg-zinc-800 shadow-xl h-64 place-items-center">
                    <div className="card-body items-center text-center">
                        ...
                        <div className="card-actions">
                            ...
                            <label htmlFor="my-modal-6" className="btn btn-sm bg-rose-600 mt-2">Live Preview</label>
                ...
                <div className="card lg:w-96 bg-zinc-800 shadow-xl h-64 place-items-center">
                    <div className="card-body items-center text-center">
                        ...
                        <div className="card-actions">
                            {/* The button to open modal */}
                            <label htmlFor="my-modal-6" className="btn btn-sm bg-rose-600 mt-2 rounded-full hover:bg-zinc-800 ">Live Preview</label>
